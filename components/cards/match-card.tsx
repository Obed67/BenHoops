...
export function MatchCard({ match }: MatchCardProps) {
  ...
  return (
    <Link href={`/matches/${match.id}`} className="block h-full">
      <Card className="group overflow-hidden transition-all hover:shadow-xl hover:shadow-orange-500/10 border-orange-200/20 dark:border-orange-900/20 hover:border-orange-400/50 dark:hover:border-orange-600/50 duration-300 cursor-pointer h-full">
